...
export const categories: Category[] = [
  ...
  },
  {
    ...
    icons: [
      ...
      dynamicBadge("Homebrew Downloads", "macos", "/homebrew/dm/node.svg?variant=secondary", "Homebrew formula monthly downloads.", "/docs/badges/homebrew"),
  ...
  },
  {
    ...
    icons: [
      ...
      dynamicBadge("Powered by Notra", "writing", "/badge/powered%20by-Notra-C8B2EE.svg?logo=notra&logoColor=1e1e1e&variant=branded", "Branded Notra badge — the AI-native writing workspace."),
      dynamicBadge("Powered by Notra (outline)", "writing", "/badge/powered%20by-Notra-C8B2EE.svg?logo=notra&variant=outline", "Subtle Notra badge for README rows."),
      dynamicBadge("Powered by Notra (secondary)", "writing", "/badge/powered%20by-Notra-C8B2EE.svg?logo=notra&variant=secondary", "Notra badge in secondary style."),
